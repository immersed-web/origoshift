...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { name: 'controlStart', path: '/teacher/start', component: () => import('pages/ControlStartPage.vue'), meta: { lowestAccessLevel: 'gatheringEditor' } },
      ...
      { name: 'userManager', path: '/teacher/users', component: () => import('pages/ManageUsersPage.vue'), meta: { lowestAccessLevel: 'gatheringEditor' } },
