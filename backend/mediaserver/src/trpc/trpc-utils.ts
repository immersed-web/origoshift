...
export type NotifierSignature<T extends Record<string, unknown>> = ((arg: {data: T, reason?: string}) => void) | undefined
...
export function attachToEvent<E extends ListenerSignature<E>, K extends UnfilteredEventTypes<E>, Data extends EventData<E, K>, TransformedResult = Data>(emitter: TypedEmitter<E>, event: K, transformer?: (data: Data) => TransformedResult){
...
export function attachToFilteredEvent<E extends ListenerSignature<E>, K extends FilteredEventTypes<E>, Data extends EventData<E, K>, TransformedResult = Data>(emitter: TypedEmitter<E>, event: K, filter: Exclude<FilterType<E, typeof event>, undefined> | ((data: Data) => boolean), transformer?: (data: Data) => TransformedResult){
